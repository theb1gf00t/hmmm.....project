...
def benchmark_inference(device='cuda', num_images=4000):
    ...
    # Main inference loop with progress counter
...
def plot_4k_comparison(results):
    ...
    fig.suptitle(f'4K Image Performance Comparison ({results[devices[0]]["total_images"]} images)', fontsize=16, fontweight='bold')
